...
export const SET_PASSWORD_NEW_ACCOUNT = 'SET_PASSWORD_NEW_ACCOUNT';
export const SWITCH_TO_SET_PASSWORD_NEW_ACCOUNT =
...
export const FORGOT_PASSWORD_CODE_FAILURE = 'FORGOT_PASSWORD_CODE_FAILURE';
export const FORGOT_PASSWORD_CODE_STATUS_RESET =
...
export const SET_ACTIVITY_CARD_VOTE = 'SET_ACTIVITY_CARD_VOTE';
export const SET_ACTIVITY_CARD_VOTE_SUCCESS = 'SET_ACTIVITY_CARD_VOTE_SUCCESS';
export const GET_VOTED_ACTIVITIES_ON_LOGIN = 'GET_VOTED_ACTIVITIES_ON_LOGIN';
export const GET_VOTED_ACTIVITIES_RECEIVED = 'GET_VOTED_ACTIVITIES_RECEIVED';

/*
PIN LOCATION TYPE SPECIFIC ACTION TYPES
*/
export const GET_PIN_LOCATION_TYPES = 'GET_PIN_LOCATION_TYPES';
export const GET_PIN_LOCATION_TYPES_RECEIVED =
...
export const GET_PINS_IMAGE_ERROR = 'GET_PINS_IMAGE_BY_ID_ERROR';
/**
